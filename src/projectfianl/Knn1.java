...
public class Knn1 {
    ...
    static double [][] wordCount =generateMatrix.genWordCount("C:\\Users\\Thilanka\\IdeaProjects\\MovieClassifier\\dtmFor5Gen.csv");          //training wordCount
    static String [] WordList=generateMatrix.genWordList("C:\\Users\\Thilanka\\IdeaProjects\\MovieClassifier\\dtmFor5Gen.csv");               //training WordList
...
//        genres.writeCrime();
        ...
        String [] s;
        ////reading file ///////////////////////////new//////////////////////////////////////////////////////////
        //String filename="C:\\Users\\Nethmi Hettiarachchi\\Documents\\NetBeansProjects\\WekaProj\\teting-plots\\divergent.txt";
        try {
      ...
      /*  double totalDistance=0.0;
        ...
        // System.out.println(resultList.get(0).genreName);//+" -> "+tempPercentage+"%");
        // tempPercentage=0.0;
        // ss[x]= resultList.get(x).genreName;
        //   }
        return resultList.get(0).genreName;
